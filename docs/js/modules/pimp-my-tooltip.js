/* Pimp My Tooltip — infobulle custom en remplacement du title natif du navigateur.
   Config facultative via window.PimpMyTooltip.Config (voir docs/tools/pimp-my-tooltip). */
...
// Reutilisable pour scanner une zone regeneree apres coup (ex: contenu injecte en AJAX).
